...
//                     let ws_py_obj = Python::with_gil(|py| Py::new(py, PyWebSocket { stream: ws_obj, rt: tokio::runtime::Handle::current() }).unwrap().into_any());
...
"#;
    ...
    #[pyo3(signature = (name=None, _description=None))]
    fn tool(&self, py: Python<'_>, name: Option<String>, _description: Option<String>) -> ToolDecorator {
    ...
    #[pyo3(signature = (name=None, _description=None))]
    fn prompt(&self, name: Option<String>, _description: Option<String>) -> PromptDecorator {
